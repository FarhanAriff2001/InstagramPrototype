...
-- Load initial data for users table
...
-- Load initial data for posts table
...
-- Load initial data for following table
...
-- Load initial data for comments table
...
-- Load initial data for likes table
